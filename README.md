...
- Encerramento manual do evento (`finish`)
...
- Edição de resultado de pod liberada enquanto a rodada não terminar
- **Async Draws**: jogador pode reportar empate no próprio pareamento sem depender do organizador (não pode reportar vitória nem sobrescrever resultado já lançado)
- Undo de rodada e swap de pareamento (organizador)
...
- Página de Perfil/Configurações (`/profile`)
